...
$order_id = $node_data->field_add_profile_order_id[LANGUAGE_NONE][0]['value'];
...
print l(t('Approve'), 'approve-advertisement/'.$nid, array('attributes' => array('class' => array('button'))));
}
else{
print 'Approved';
}
