...
<div class="container">
    <section<?php print $content_column_class; ?>>
      ...
      <?php global $user; global $base_url;
	      	$roles = $user->roles;
          //$uid = $user->uid;
	       if( in_array( 'student', $roles ) && arg(0) != "student-dashboard") {
            echo "<div class='back-to-dashboard'><a href='$base_url/student-dashboard'>Dashboard</a></div>";
          } elseif( in_array( 'teacher', $roles ) && arg(0) != "teacher-dashboard") {
            ...
            echo "<div class='back-to-dashboard'><a href='$base_url/super-admin-dashboard'>Dashboard</a></div>";
          }
      ?>
      <a id="main-content"></a>
