...
//SAT test
if( $q == 'node/181/take' ) {
	echo "<div class='text-center test-save'><a class='button' href='$base_url/node/187/take'>SAT Maths</a></div>";
} else if( $q == 'node/187/take' ) {
	echo "<div class='text-center test-save'><a class='button' href='$base_url/node/188/take'>SAT Writing and Language</a></div>";
}

//GMAT test
if( $q == 'node/212/take' ) {
	echo "<div class='text-center test-save'><a class='button' href='$base_url/node/213/take'>GMAT Quant</a></div>";
} else if( $q == 'node/213/take' ) {
	echo "<div class='text-center test-save'><a class='button' href='$base_url/node/193/take'>GMAT Integrated Reasoning</a></div>";
}

//GRE TEST
if( $q == 'node/183/take' ) {
	echo "<div class='text-center test-save'><a class='button' href='$base_url/node/222/take'>GRE Test - Verbal Reasoning - Section 2</a></div>";
} else if( $q == 'node/222/take' ) {
	echo "<div class='text-center test-save'><a class='button' href='$base_url/node/189/take'>GRE Test - Quantitative Reasoning - Section 1</a></div>";
} else if( $q == 'node/189/take' ) {
	echo "<div class='text-center test-save'><a class='button' href='$base_url/node/223/take'>GRE Test - Quantitative Reasoning - Section 2</a></div>";
}
